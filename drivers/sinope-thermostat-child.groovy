...
def executeChildResponse(data) {
    ...
    switch(response.type) {
        ...
        case [MESSAGE_TYPES.AWAY]:
            ...
            Utils.toLogger("debug", "received executeChildResponse away: ${response.value}")
            break
...
float FormatTemperature(temperature, locationScale) {
    ...
    Utils.toLogger("debug", "FormatTemperature - temperature before conversion: ${formattedTemperature}")
